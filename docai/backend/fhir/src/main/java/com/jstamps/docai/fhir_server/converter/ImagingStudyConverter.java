...
import com.jstamps.docai.fhir_server.entity.imagingStudy.ImagingStudyEntity;
import com.jstamps.docai.fhir_server.entity.imagingStudy.ImagingStudySeria;
...
public class ImagingStudyConverter implements EntityFHIRConverter<ImagingStudyEntity, ImagingStudy> {
    ...
    public ImagingStudyEntity convertFHIRToDBEntity(ImagingStudy imagingStudy) {
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Reference location = new com.jstamps.docai.fhir_server.entity.imagingStudy.Reference();
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Reference subject = new com.jstamps.docai.fhir_server.entity.imagingStudy.Reference();
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Meta metaDb = new com.jstamps.docai.fhir_server.entity.imagingStudy.Meta();
        metaDb.setSource(meta.getSource());
        imagingStudyEntity.setMeta(metaDb);

        Collection<com.jstamps.docai.fhir_server.entity.Identifier> identifiers = new LinkedHashSet<>();
        for(Identifier identifier : imagingStudy.getIdentifier()){
            com.jstamps.docai.fhir_server.entity.Identifier identifierDb = new com.jstamps.docai.fhir_server.entity.Identifier();
        ...
        if(imagingStudy.getModality().size() == 1){
            ...
            com.jstamps.docai.fhir_server.entity.imagingStudy.Coding codingDb = new com.jstamps.docai.fhir_server.entity.imagingStudy.Coding();
        ...
        if(imagingStudy.getSeries().size() == 1){
            ...
            com.jstamps.docai.fhir_server.entity.imagingStudy.Coding coding = new com.jstamps.docai.fhir_server.entity.imagingStudy.Coding();
    ...
    public ImagingStudy convertDBToFhirEntity(ImagingStudyEntity imagingStudyEntity) {
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Reference referenceLocationDb = imagingStudyEntity.getLocation();
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Reference referenceSubjectDb = imagingStudyEntity.getSubject();
        ...
        for(com.jstamps.docai.fhir_server.entity.Identifier identifier: imagingStudyEntity.getIdentifiers()){
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Meta metaDb = imagingStudyEntity.getMeta();
        Meta meta = new Meta()
//                .addProfile(metaDb.getProfile().toString())
                .setSource(metaDb.getSource());
        imagingStudy.setMeta(meta);

        com.jstamps.docai.fhir_server.entity.imagingStudy.Coding codingModalityDb = imagingStudyEntity.getModality();
        ...
        for(ImagingStudySeria imagingStudySeria : imagingStudyEntity.getSeries()) {
            ...
            com.jstamps.docai.fhir_server.entity.imagingStudy.Coding codingSeriaDb = imagingStudySeria.getBody();
...
//        imagingStudy.setText(narrative);
        ...
        com.jstamps.docai.fhir_server.entity.imagingStudy.Coding procedureCodeDb = new com.jstamps.docai.fhir_server.entity.imagingStudy.Coding();
